...
from bank_application import invalid_amount_exception
...
class MyTestCase(unittest.TestCase):
    ...
    #     account.withdraw(4000, "6969")
    #     with self.assertRaises(InsufficientFundsException) as error:
    #         self.assertEqual(3000, account.check_balance("6969"))
